...
# Video mit Text erzeugen, Text von Rechts in die Mitte bewegen und rotieren
...
def create_frame(t):
    ...
    text_img = gizeh.text(text, fontfamily=schrift, fontsize=textgroesse,
               ...
               xy=(videobreite-t*(videobreite/2)/videolaenge,videohoehe/2))
    text_rotation = text_img.rotate(t*(2*3.14/videolaenge), center=[videobreite-t*(videobreite/2)/videolaenge,videohoehe/2])
...
# text_bewegen_rechts2mitte_rotieren.py
