...
# Video mit Text erzeugen, Text von Oben in die Mitte bewegen und rotieren
...
def create_frame(t):
    ...
    text_img = gizeh.text(text, fontfamily=schrift, fontsize=textgroesse,
               ...
               xy=(videobreite/2,t*(videohoehe/2)/videolaenge))
    text_rotation = text_img.rotate(t*(2*3.14/videolaenge), center=[videobreite/2,t*(videohoehe/2)/videolaenge])
...
# text_bewegen_oben2mitte_rotieren.py
