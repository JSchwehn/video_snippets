...
# Video mit Text erzeugen, Text von Links in die Mitte bewegen und rotieren
...
def create_frame(t):
    ...
    text_img = gizeh.text(text, fontfamily=schrift, fontsize=textgroesse,
               ...
               xy=(t*(videobreite/2)/videolaenge,videohoehe/2))
    text_rotation = text_img.rotate(t*(2*3.14/videolaenge), center=[t*(videobreite/2)/videolaenge,videohoehe/2])
...
# text_bewegen_links2mitte_rotieren.py
